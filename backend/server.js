...
var messages = [{text: 'some text', owner: 'Corey'},{text: 'other message', owner: 'Christina'}];
var users = [{firstName: 'a', email: 'a@a.com', password:'a', id: 0}]; //{firstName: 'a', email: 'a@a.com', password:'a', id: 0}
